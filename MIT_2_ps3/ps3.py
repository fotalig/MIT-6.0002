...
class RectangularRoom(object):
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        if self.dirt_amount[int(pos.get_x()), int(pos.get_y())] < 0:
    ...
    def is_position_in_room(self, pos):
        ...
        """
        if pos.get_x() >= 0 and pos.get_y() >= 0:
            return int(pos.get_x()) < self.width and int(pos.get_y()) < self.height
        return False
...
class Robot(object):
    ...
    def __init__(self, room: RectangularRoom, speed, capacity):
        ...
        """
        self.room = room
        self.pos_x = random.randint(0, self.room.width)
        self.pos_y = random.randint(0, self.room.height)
    ...
    def set_robot_position(self, position):
        ...
        """
        self.pos_x = position.get_x()
        self.pos_y = position.get_y()
